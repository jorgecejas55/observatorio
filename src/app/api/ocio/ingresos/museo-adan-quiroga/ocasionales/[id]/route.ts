...
// GET /api/ocio/ingresos/museo-adan-quiroga/ocasionales/[id] - Obtener una visita ocasional por ID
export async function GET(
  ...
  try {
    ...
    console.error('[museo-adan-quiroga/ocasionales/id GET]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}

// PUT /api/ocio/ingresos/museo-adan-quiroga/ocasionales/[id] - Actualizar visita ocasional
export async function PUT(
  ...
  try {
    ...
    console.error('[museo-adan-quiroga/ocasionales/id PUT]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}

// DELETE /api/ocio/ingresos/museo-adan-quiroga/ocasionales/[id] - Eliminar visita ocasional
export async function DELETE(
  ...
  try {
    ...
    console.error('[museo-adan-quiroga/ocasionales/id DELETE]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}
