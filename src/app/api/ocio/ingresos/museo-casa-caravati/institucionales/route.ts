...
// GET /api/ocio/ingresos/museo-casa-caravati/institucionales - Obtener todas las visitas institucionales
export async function GET() {
  try {
    ...
    console.error('[museo-casa-caravati/institucionales GET]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}

// POST /api/ocio/ingresos/museo-casa-caravati/institucionales - Crear nueva visita institucional
export async function POST(req: Request) {
  try {
    ...
    console.error('[museo-casa-caravati/institucionales POST]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}
