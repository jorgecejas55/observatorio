...
export async function GET(
  ...
  try {
    ...
    console.error('[museo-casa-caravati/institucionales/id GET]', err)
...
export async function PUT(
  ...
  try {
    ...
    console.error('[museo-casa-caravati/institucionales/id PUT]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('[museo-casa-caravati/institucionales/id DELETE]', err)
    return NextResponse.json({ success: false, error: 'Error interno del servidor' }, { status: 500 })
  }
}
