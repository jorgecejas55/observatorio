...
function MuseoAdanQuirogaDashboardContent() {
  const { isAuthenticated, loading, login, logout, getUserInfo } = useMuseoAdanQuirogaAuth()
  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
        <div>
          <h2 className="section-title">Museo Arqueológico Adán Quiroga</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Visitas Ocasionales */}
        <Link
          href="/ocio/ingresos/museo-adan-quiroga/ocasionales"
        ...
        <Link
          href="/ocio/ingresos/museo-adan-quiroga/institucionales"
          className="card p-6 card-hover group"
        >
          <div className="flex items-start gap-4">
        ...
        <Link
          href="/ocio/ingresos/museo-adan-quiroga/dashboard"
          className="card p-6 card-hover group"
        >
          <div className="flex items-start gap-4">
...
export default function MuseoAdanQuirogaDashboardPage() {
  return (
    <MuseoAdanQuirogaAuthProvider>
      <MuseoAdanQuirogaDashboardContent />
    </MuseoAdanQuirogaAuthProvider>
  )
}
