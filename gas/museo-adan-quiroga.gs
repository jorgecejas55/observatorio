/**
 * GOOGLE APPS SCRIPT - MUSEO ARQUEOLÓGICO ADÁN QUIROGA
 * Sistema de registro de visitas ocasionales e institucionales
 *
 * INSTRUCCIONES DE DEPLOY:
 * 1. Abrir Google Sheet: https://docs.google.com/spreadsheets/d/15_ZDtwVIxhqT-C5YAjEvVXPJaduvqtuuur5hQq74aew/edit
 ...
 * 6. Copiar URL y agregar a .env.local como MUSEO_ADAN_QUIROGA_SCRIPT_URL
 */

// ID del Google Sheet (configuración)
const SHEET_ID = '15_ZDtwVIxhqT-C5YAjEvVXPJaduvqtuuur5hQq74aew';
...
function setup() {
  ...
  Logger.log('=== SETUP MUSEO ARQUEOLÓGICO ADÁN QUIROGA ===');
  ...
  if (wsUsers.getLastRow() === 0) {
    ...
    Logger.log('✅ Hoja "' + SHEETS.USUARIOS + '" creada con usuario admin@adan-quiroga.com / 123456');
  } else {
...
function testLogin() {
  const user = verifyUser('admin@adan-quiroga.com', '123456');
...
function testLoginDetallado() {
  ...
  const email = 'admin@adan-quiroga.com';
